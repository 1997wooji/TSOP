...
/*	public static void main(String[] args)
	{
		...
		System.out.println(dao.addPlaylist("jiwootitle", "\\playlistimage\\12", strs, "占쏙옙트占싸듀스占쏙옙占싱쇽옙~占쏙옙", true, "jiwookkkk", "playlistjiwoopath"));
		
		
		
		String[] strs2={"tag4","tag5","tag6"};
		System.out.println(dao.updatePlaylist(31, "jiwootitle2","\\playlistimage\\32", strs2, "占쏟내몌옙占쏙옙호占쏙옙~占쏙옙~", false));
	...
	Object[] list=dao.searchPlaylist("占쏙옙占�", 1);
		...
		for(int i=0; i<list.length; i++)
		{
			...
			System.out.println(vo.toString());
		}占싱곤옙 like view占쏙옙占쏙옙 占쏙옙占싶쇽옙 占쏙옙占쏙옙!!
...
*/
	...
	public Object[] searchPlaylist(String key, int flag) {
		...
		try {
			...
			while(rs.next()){
				...
				{
					/*rs.getString("tag_name").contains(cs) tag占쏙옙 null 占쏙옙占쏙옙 占쏙옙載∽옙占� 占쏙옙占쏙옙*/
					//占쏙옙占쏙옙占싹곤옙 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙!
	...
	/*占쏙옙 playlist占쏙옙 repost占쏙옙 member占쏙옙 占쏙옙占쏙옙占싼댐옙. */
	...
	/*占쏙옙 playlist占쏙옙 占쏙옙占싣울옙占쏙옙 member占쏙옙 占쏙옙占쏙옙占싼댐옙.*/
	public Object[] searchLikePlaylist(int playlistId) {
		return null;
	}
	
	/*like count 占쏙옙占쏙옙占쏙옙 10占쏙옙 占쏙옙占쏙옙*/
...
public String searchPlaylistFilePath(int playlistId){
		Connection conn = 	null;
		PreparedStatement pstmt = null;
		ResultSet rs=null;
		...
		try {
			conn = ConnectDB.connect();
			pstmt=conn.prepareStatement("select PLAYLIST_PATH from PLAYLIST_PATH_TB where PLAYLIST_ID=?");
			pstmt.setInt(1, playlistId);
			rs = pstmt.executeQuery();
			rs.next();
