...
public class MemberDAO {
	...
	public String updateMember(String memberId, String memberIntro, String imagePath) {
		...
		try {
			...
			imageId=imageDao.addImage(imagePath); 
...
public String deleteMember(String memberId, String memberPwd) {
	...
	public String searchImagePath(String memberId){
		...
		try {
			...
			conn = ConnectDB.connect();
			pstmt=conn.prepareStatement("select image_path from image_tb where image_id=?");
			pstmt.setInt(1, imageId);
			rs=pstmt.executeQuery();
