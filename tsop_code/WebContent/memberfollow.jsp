...
<div class="container">
	<div class="container content p-0 border bg-white">
		...
		<nav class="nav border-bottom"> 
		  ...
		  <a class="nav-link active" href="./memberfollows.do?memberId=${member.memberId }">Follows</a>
		...
		<div class="container">
			...
			<div class="card-columns p-5">
				<c:forEach items="${follows }" var="follow">
				  <div class="card follow shadow">
				  	<input type="hidden" value="${follow.memberId }" name="memberId">
				  	<img class="card-img-top p-2" src="${follow.imagePath }" alt="Card image cap">
				    <div class="card-body text-center" style="width:200px">
				      <h5 class="card-title">${follow.memberNickName }</h5>
				    </div>
				  </div>
				 </c:forEach>
			</div>
